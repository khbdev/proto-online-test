...
const file_proto_auth_auth_proto_rawDesc = "" +
	...
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken2z\n" +
	"\vAuthService\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x129\n" +
	"\fRefreshToken\x12\x14.auth.RefreshRequest\x1a\x13.auth.LoginResponseB.Z,github.com/khbdev/grps-proto/proto/auth;authb\x06proto3"
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	2, // 1: auth.AuthService.RefreshToken:input_type -> auth.RefreshRequest
	1, // 2: auth.AuthService.Login:output_type -> auth.LoginResponse
	1, // 3: auth.AuthService.RefreshToken:output_type -> auth.LoginResponse
